...
public class GetRequest07 extends RegresinBaseUrl {
    ...
    public void test07(){
        ...
        // "/{parametre1}/{parametre2}" url in https://regres.in  den sonrasini /api  /users demek oluyor
        ...
        // System.out.println(json.getString("data.first_name")); ayni islevi goruyor
