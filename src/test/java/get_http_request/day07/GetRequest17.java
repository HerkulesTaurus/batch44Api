...
public class GetRequest17 extends GMIBankBaseUrl {
    ...
    public void test17(){
        ...
        //***1******De-Serialization  asagıdaki JSON formatindaki detayi MAP'e donusturur

        //id=1
        //firstName=Martha
        //lastName=Duman bilgilerini donusturur

        //***222****JSON datasının MAP e donusmus hali

        // Data yı Json formatı JAVA ya de-serialization
        // DATA yı Java dan Json formatına serialization
